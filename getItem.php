...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])) {
    ...
    <div class="col-md-8 col-sm-6 col-xs-12">
        <div class="modal-image">
            <img class="img-responsive img-box" src="<?= echoPath(_UPLAODS_, $item['Images']) ?>" alt="<?= $item['Title'] ?>" />
        </div>
    </div>
    <div class="col-md-4 col-sm-6 col-xs-12" data-id="<?= $item['ID'] ?>">
        <div class="product-short-details">
            ...
            <a href="#" class="btn btn-main " id="additem">Add To Cart</a>
